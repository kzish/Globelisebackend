...
(
    ...
    CONSTRAINT prefilled_entity_clients_bank_details_pkey PRIMARY KEY (email)
);
...
(
    ...
    CONSTRAINT prefilled_entity_clients_payment_details_pkey PRIMARY KEY (email)
);
...
(
    ...
    CONSTRAINT prefilled_entity_clients_pic_details_pkey PRIMARY KEY (email)
);
...
(
    ...
    logo bytea,
    CONSTRAINT prefilled_entity_clients_account_details_pkey PRIMARY KEY (email)
);
