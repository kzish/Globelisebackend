...
--
-- Name: prefilled_individual_contractors_account_details_by_admin; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.prefilled_individual_contractors_account_details_by_admin (
    email TEXT NOT NULL PRIMARY KEY,
    first_name text NOT NULL,
    last_name text NOT NULL,
    dob timestamp with time zone NOT NULL,
...
ALTER TABLE public.prefilled_individual_contractors_account_details_by_admin OWNER TO postgres;
