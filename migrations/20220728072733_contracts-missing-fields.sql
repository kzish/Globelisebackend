...
ADD COLUMN payment_calculation_settings text COLLATE pg_catalog."default";

ALTER TABLE IF EXISTS public.contracts
ADD COLUMN statutory_fund_settings text COLLATE pg_catalog."default";


ALTER TABLE IF EXISTS public.contracts
ADD COLUMN tax_settings text COLLATE pg_catalog."default";
